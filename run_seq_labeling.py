...
def main():  # noqa C901
    ...
    config = config_class.from_pretrained(
        "layoutlm-base-uncased/",#args.config_name if args.config_name else args.model_name_or_path,
    ...
    model = model_class.from_pretrained(
        "layoutlm-base-uncased/",#args.model_name_or_pat"layoutlm-base-uncased/",h,
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        tokenizer = tokenizer_class.from_pretrained(
            "microsoft/layoutlm-base-uncased",force_download  = True, do_lower_case=args.do_lower_case,ignore_mismatched_sizes=True)
